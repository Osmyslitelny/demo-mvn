...
public class DuckduckgoAtlasTest {

    private final static String UI_URL = "https://duckduckgo.com";
    private final static String API_URL = "http://duckduckgo.com/?q=wikipedia&format=json";
    ...
    @Test
    public void api_test() throws IOException {
        ...
        Assert.assertEquals(response.toString(), JSON_API_RESPONSE);
    }

    @Test
    public void ui_test() {
        System.setProperty("webdriver.chrome.driver", "D:\\demo-ta\\demo-mvn\\src\\test\\resources\\chromedriver.exe");

        WebDriver driver = new ChromeDriver();
        driver.get(UI_URL);
        WebElement webElement = driver.findElement(By.xpath("//input[@name='q']"));
        webElement.sendKeys(WIKIPEDIA);
        driver.findElement(By.xpath("//input[@type='submit']")).click();
        driver.findElement(By.xpath("//*[@class='result__a']")).click();
